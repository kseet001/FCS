...
class CustomAES:
    ...
    def encrypt(self, plaintext):
        ...
        for i in range(0, self.rounds, 1):
            ...
            state = self.add_round_key(state, expanded_key, 16 * (i+1))
    ...
    def key_expansion(self, input_key):
        ...
        rcon_iteration = 0  # Rcon iteration begins at 1
        ...
        while bytes_generated < 176:
            ...
            if bytes_generated % 16 == 0:
                tmp = self.key_expansion_core(tmp, rcon_iteration)
                rcon_iteration += 1
